        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide">
            <div class="select__card">
              <img src="{{ asset('img/assets/select-1.png') }}" alt="select" />
          ...
          <div class="swiper-slide">
            <div class="select__card">
              <img src="{{ asset('img/assets/select-3.png') }}" alt="select" />
              <div class="select__info">
                <div class="select__info__card">
                  <span><i class="ri-speed-up-line"></i></span>
          ...
          <div class="swiper-slide">
            <div class="select__card">
              <img src="{{ asset('img/assets/select-5.png') }}" alt="select" />
              <div class="select__info">
                <div class="select__info__card">
                  <span><i class="ri-speed-up-line"></i></span>
    ...
    <section class="download">
      <div class="section__container download__container">
        <div class="download__content">
          <h2 class="section__headerr">Testimoni Pelanggan</h2>
